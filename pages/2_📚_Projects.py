...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="/Hakkinda">Hakkında</a>
                    </li>
                      <li class="nav-item">
                          <a class="nav-link " aria-current="page" href="/uygulama">programa giriş</a>
                      </li>
        ...
        <div class='divstyle' style='margin:40px 20px 60px 20px'>
            <div class="row py-3">
                <div class="col md-3">
                    ...
                    <a href="./uygulama"><img src="../static/icons/ana_sayfa.jpeg" class="img-fluid mx-auto d-block"></a>
                </div>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/js/bootstrap.bundle.min.js"
    ...
    """,
    width=1200, height=1200, scrolling=True
)