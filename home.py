        ...
        <div class='divstyle' style='margin:40px 20px 60px 20px'>
            <div class="row py-3">
                <div class="col md-3">
                    ...
                    <a href="/templates/uygulama.html"><img src="https://www.google.com/search?q=yapay+zeka&sxsrf=AJOqlzVun-ltD3JsFqUQna9fCSkpIAGOOA:1677874982624&source=lnms&tbm=isch&sa=X&ved=2ahUKEwjr88Oyy8D9AhXBR_EDHSzdDOoQ_AUoAXoECAEQAw&biw=1366&bih=625&dpr=1#imgrc=xloZ45r2vcz5gM" class="img-fluid mx-auto d-block"></a>
                </div>
